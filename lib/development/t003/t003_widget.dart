...
class _T003WidgetState extends State<T003Widget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.subjects = await querySubjectListRecordOnce();
      _model.subjectTimes = await querySubjectTimeRecordOnce(
        singleRecord: true,
            ...
            children: [
              ...
              Align(
                ...
                child: FlutterFlowDropDown<String>(
                  ...
                  options: _model.subjects!.map((e) => e.subjectName).toList(),
                  onChanged: (val) =>
              ...
              Align(
                alignment: const AlignmentDirectional(-1.0, 0.0),
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(34.0, 10.0, 0.0, 0.0),
                  child: Text(
                    '時間を選択してください',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Karma',
              ...
              Align(
                ...
                child: FlutterFlowDropDown<String>(
                  controller: _model.dropDownValueController2 ??=
                      FormFieldController<String>(null),
                  options: _model.subjectTimes!.subjectTime,
                  onChanged: (val) =>
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    var subjectRecordReference = SubjectRecord.collection.doc();
                    await subjectRecordReference.set(createSubjectRecordData(
                      subjectName: _model.dropDownValue1,
                      serial: _model.uuid,
                      date: getCurrentTimestamp,
                      subjectDate: _model.dropDownValue2,
                    ));
                    _model.nowSubjectDate = SubjectRecord.getDocumentFromData(
